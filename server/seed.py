...
if __name__ == '__main__':
    ...
    with app.app_context():
        ...
        recipe3 = Recipe(title='Xiao Long Bao', image='', description='', chef_id=1)
        recipes.append(recipe3)
        recipe4 = Recipe(title='Wonton Soup', image='', description='', chef_id=1)
        ...
        recipe14 = Recipe(title='Japanese desserts', image='', description='', chef_id=3)
        recipes.append(recipe14)
        recipe15 = Recipe(title='Tex Mex pizza', image='', description='', chef_id=4)
        recipes.append(recipe15)
        recipe16 = Recipe(title='Pecan Pie', image='', description='', chef_id=4)
        recipes.append(recipe16)
        recipe17 = Recipe(title='Texas bbq', image='', description='', chef_id=4)
        recipes.append(recipe12)
        recipe18 = Recipe(title='', image='', description='', chef_id=4)
        recipes.append(recipe18)
        recipe19 = Recipe(title='', image='', description='', chef_id=4)
        recipes.append(recipe19)
        recipe20 = Recipe(title='', image='', description='', chef_id=4)
        recipes.append(recipe20)
        recipe21 = Recipe(title='Garlic Naan', image='', description='', chef_id=5)
        recipes.append(recipe21)
        recipe22 = Recipe(title='Biryani', image='', description='', chef_id=5)
        recipes.append(recipe22)
        recipe23 = Recipe(title='', image='', description='', chef_id=5)
        recipes.append(recipe23)
        recipe24 = Recipe(title='Kalakand (Milk Cake)', image='', description='', chef_id=5)
        recipes.append(recipe24)
        recipe25 = Recipe(title='Farmers Market Produce', image='', description='', chef_id=5)
