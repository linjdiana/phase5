...
if __name__ == '__main__':
    ...
    with app.app_context():
        ...
        # reviews = []
        # r1 = Review(user='', rating='♡♡♡♡', text='The food was so good! I took a star off because Diana was late.', chef_id=1, user_id=7)
        # reviews.append(r1)
        # r2 = Review(user='', rating='♡♡♡♡♡', text='boopp boop', chef_id=3, user_id=1)
        # reviews.append(r2)
        # r3 = Review(user='', rating='♡♡♡♡', text='', chef_id=4, user_id=9)
        # reviews.append(r3)
        # r4 = Review(user='', rating='♡♡♡♡♡', text='', chef_id=2, user_id=4)
        # reviews.append(r4)
        # r5 = Review(user='', rating='♡♡', text='Diana was late.', chef_id=1, user_id=5)
        # reviews.append(r5)
        # r6 = Review(user='', rating='♡♡♡♡♡', text='Anika is the best -- she's so warm and friendly, and she even made extra food for my friends who aren't super adventurous eaters.', chef_id=5, user_id=2)
        # reviews.append(r6)
        # r7 = Review(user='', rating='♡♡', text='', chef_id=5, user_id=1)
        # reviews.append(r7)
        # r8 = Review(user='', rating='♡♡♡♡', text='', chef_id=4, user_id=1)
        # reviews.append(r8)
        # r9 = Review(user='', rating='♡♡♡♡♡', text='', chef_id=1, user_id=6)
        # reviews.append(r9)
        # r10 = Review(user='', rating='♡♡♡♡♡', text='', chef_id=2, user_id=7)
        # reviews.append(r10)
        # r11 = Review(user='', rating='♡♡♡♡', text='', chef_id=3, user_id=5)
        # reviews.append(r11)
        # r12 = Review(user='', rating='♡♡♡', text='', chef_id=2, user_id=3)
        # reviews.append(r12)
        # r13 = Review(user='', rating='♡♡♡♡', text='', chef_id=3, user_id=4)
        # reviews.append(r13)
        # r14 = Review(user='', rating='♡♡♡', text='', chef_id=2, user_id=8)
        # reviews.append(r14)
        # r15 = Review(user='', rating='♡♡♡♡', text='', chef_id=1, user_id=9)
        # reviews.append(r15)
        # r16 = Review(user='', rating='♡♡♡♡', text='', chef_id=1, user_id=5)
        # reviews.append(r16)
        # r17 = Review(user='', rating='♡♡♡♡', text='', chef_id=3, user_id=3)
        # reviews.append(r17)
        # r18 = Review(user='', rating='♡♡♡♡♡', text='', chef_id=2, user_id=2)
        # reviews.append(r18)
