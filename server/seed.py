...
if __name__ == '__main__':
    ...
    with app.app_context():
        ...
        recipe27 = Recipe(title='Zong Zi', image='https://raw.githubusercontent.com/linjdiana/phase5/main/project%20images/Zongzi-two-ways-landscape2.jpg', description='These delectable, savory Chinese pastries can be eaten at any meal. Sticky rice wrapped in grape leaves then steamed, you can add any filling inside!', chef_id=1)
        recipes.append(recipe27)
        recipe28 = Recipe(title='Chocolate Chip Cookies', image='https://raw.githubusercontent.com/linjdiana/phase5/main/project%20images/JT-Chocolate-Chip-Cookies-master768.jpg', description='Timeless classic.', chef_id=1)
        recipes.append(recipe28)
        recipe29 = Recipe(title='Beef Wellington', image='https://raw.githubusercontent.com/linjdiana/phase5/main/project%20images/beef%20wellington.jpeg', description='Besides his Italian dishes, Gordon also has lots of other European favorites! Here\'s a huge cut of beef tenderloin inside a puff pastry.', chef_id=2)
        recipes.append(recipe29)
        recipe30 = Recipe(title='Truffle Lobster Mac and Cheese', image='https://raw.githubusercontent.com/linjdiana/phase5/main/project%20images/truffle%20lobster.jpeg', description='Italian man who grew up in America and fell victim to Mac and Cheese....', chef_id=2)
